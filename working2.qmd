...
Let's have a look at the **details** section of the function *sd*. This section contains an important piece of information, namely that the function uses the denominator $n-1$. What this means is that the function *sd* computes an unbiased estimate of the population standard deviation by multiplying the (uncorrected) sample standard deviation by $\frac{n}{n-1}$. 
