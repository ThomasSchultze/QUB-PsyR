...
This means that we should disentangle main effects only if there is no evidence of an interaction or is the interaction is ordinal.
:::
...
Now let's run a custom contrast analysis on the ANOVA object using *emmeans* and coapre it to the ANOVA results. Here is the syntax:
