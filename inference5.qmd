...
int_plot = function(){
  ...
  plot(1,1, col = 'white', axes = F, ylab = "", xlab = "", xlim = c(0,2),
       ylim = c(0,10))
  box(bty = 'L')
  axis(1, at = c(0.25, 1.75), labels = c("j = 1", "j = 2"), padj = -0.75, tcl = -0.2, cex.axis = 1.15)
  axis(2, at = seq(0, 10, 2.5), padj = 0.75, tcl = -.2, cex.axis = 1.15)
  mtext("Factor A", side = 1, padj = 1.85, cex = 1.5, font = 2)
  mtext("dependent variable", side = 2, padj = -1.85, cex = 1.75, font = 2)
