...
:::{.alert .alert-sucess}
**Note**: R has a neat way of reversing functions such as *is.na*, *is.numeric*, and *is.finite*. We can make R test the respective opposite by preceding the function call with an exclamation mark (similar to how we test inequality using the operator **!=**).
