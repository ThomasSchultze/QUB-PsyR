...
$\chi^2 = \frac{(x_i - e_i)^2}{e_i}$ 

Here, $x_i$ denote the observed frequencies in category *i* whereas *e_i* represents the expected frequencies given some assumed distribution. The most common analyses for which the $\chi^2$-test is used are:
